...
Added 14 extra tests to internal/detector/ covering each project type detection path, unknown/empty defaults, HasBun, GenerateConfig defaults, all-types combined, and Node lint script handling.
...
.glm-agent-counter                                 |   2 +-
 ...
 42 files changed, 230 insertions(+), 3843 deletions(-)
```
