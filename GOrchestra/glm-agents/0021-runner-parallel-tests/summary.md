...
Added 8 tests to internal/runner/runner_parallel_test.go covering parallel execution, fail-fast with parallel, retry with count=2, and retry_on_trace_only behavior

**Files Changed**:
- internal/runner/runner_parallel_test.go

## Diff Summary

```
.glm-agent-counter                                 |    2 +-
 .glm-agent-history.yaml                            |   32 -
 ...
 52 files changed, 230 insertions(+), 5455 deletions(-)
```
