...
Added cmd/root_extra_test.go with 4 tests for root command: subcommand presence, version output, --help flag, unknown subcommand error.

**Files Changed**:
- cmd/root_extra_test.go
...
.glm-agent-counter                                 |   2 +-
 ...
 10 files changed, 225 insertions(+), 381 deletions(-)
```
